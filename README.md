...
Heavily inspired by the [hangups library](https://github.com/tdryer/hangups) by Tom Dryer (et. al.) using code from [Nakul Gulati](https://nakulgulati.com) and protobufs from [Darryl Pogue](http://dpogue.ca/)
